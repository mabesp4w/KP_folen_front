...
import { Home, Music, Calendar, Camera, X, LogIn, ChevronRight } from "lucide-react";
                ...
                <div className="flex flex-col h-full">
                    ...
                    <div className="bg-gradient-to-r from-primary to-secondary p-6 text-white">
                        ...
                        <div className="bg-white/10 rounded-lg p-3 backdrop-blur-sm">
                            ...
                            <p className="text-xs text-white/80">Rum Fararur Production</p>
                        </div>
                    </div>
                    ...
                    `}>
                        ...
                        <button
                            onClick={handleLogin}
                            className="flex items-center gap-4 px-4 py-3 rounded-lg w-full transition-all hover:bg-primary/10 active:bg-primary/20 text-primary group"
                        >
                            ...
                            <div className="flex-1 text-left">
                                ...
                                <p className="text-xs text-primary/80">Masuk ke akun Anda</p>
                            </div>
